...
| B | CN4 | Black | C9900020526 / PH-4A black; availability must be confirmed at quotation |
...
- Port B uses a C990 custom-library item, so availability is not equivalent to a normal stocked LCSC component.
